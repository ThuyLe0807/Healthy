        ...
        {bmiResult && (
          <View style={{ alignItems: 'center', marginTop: 20 }}>
            {bmiResult === 'Chưa có dữ liệu' ? (
              ...
              <>
                <Text style={{ fontSize: 20, color: '#000' }}>{`BMI của bạn: ${bmiResult}`}</Text>
                <Text style={{ fontSize: 18, color: '#000', marginTop: 10 }}>{`Trạng thái: ${bmiCategory}`}</Text>
                <Text style={{ fontSize: 18, color: '#000', marginTop: 10, padding: 8, textAlign: 'Gợi ý' }}>
